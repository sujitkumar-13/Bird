...
const WhatsAppFloatingButton = () => {
  ...
  const whatsappUrl = `https://wa.me/919997690669?text=Hi! I'm interested in Digibazzar's digital marketing services.`;
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="mb-4 w-[320px] md:w-[350px] bg-white rounded-2xl shadow-2xl overflow-hidden border border-neutral-100"
          >
            {/* Header */}
                ...
                <div className="flex items-center gap-4">
                  <div className="relative">
                    <div className="w-12 h-12 bg-neutral-200 rounded-full flex items-center justify-center overflow-hidden border-2 border-neutral-100">
                      <img
                        src="https://pps.whatsapp.net/v/t61.24694-24/491841535_3027908087368210_4327614965840322677_n.jpg?ccb=11-4&oh=01_Q5Aa3gFHFnJ4M4PRc6NBs7ue9UDmjS9ydirIB2M4XhTwYo87qg&oe=6981C542&_nc_sid=5e03e0&_nc_cat=104"
                        alt="Hritik sharma"
                  ...
                  <div>
                    <h4 className="font-bold text-neutral-800">Hritik sharma</h4>
